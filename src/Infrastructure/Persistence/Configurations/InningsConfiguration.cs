    ...
    : IEntityTypeConfiguration<Innings>
{
    public void Configure(EntityTypeBuilder<Innings> builder)
    {
        ...
        builder.Property(x => x.InningsNumber)
            .IsRequired();

        builder.Property(x => x.BattingTeamId)
            .IsRequired();

        builder.Property(x => x.BowlingTeamId)
            .IsRequired();
        ...
        builder.Property(x => x.TargetRuns)
            .IsRequired(false);
        ...
        builder.Property(x => x.TotalBalls)
            .IsRequired();

        builder.Property(x => x.CurrentStrikerId)
            .IsRequired();

        builder.Property(x => x.CurrentNonStrikerId)
            .IsRequired();

        builder.Property(x => x.CurrentBowlerId)
            .IsRequired();
